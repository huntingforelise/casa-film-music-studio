...
const hasImage = (value, slot) => { var _a; return Boolean((_a = value[slot]) === null || _a === void 0 ? void 0 : _a.image); };
export const photoMosaicSection = defineType({
    ...
    preview: {
        ...
        prepare(selection) {
            const count = SLOT_KEYS.filter((key) => { var _a; return Boolean((_a = selection[key]) === null || _a === void 0 ? void 0 : _a.image); }).length;
            const layoutLabel = count >= 9 ? '9 images' : count >= 6 ? '6 images' : count >= 3 ? '3 images' : '0 images';
            return {
                title: 'Photo Mosaic Section',
