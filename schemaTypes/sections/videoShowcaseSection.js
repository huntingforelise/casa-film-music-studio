...
export const videoShowcaseSection = defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            type: 'array',
            of: [{ type: 'videoItem' }],
            validation: (Rule) => Rule.custom((videos, context) => {
                var _a;
                const orientation = (_a = (context === null || context === void 0 ? void 0 : context.parent)
                    .mediaOrientation) !== null && _a !== void 0 ? _a : 'landscape';
