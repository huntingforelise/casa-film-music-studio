...
export const mediaTextSection = defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            validation: (Rule) => Rule.required().custom((value, context) => {
                const parent = context === null || context === void 0 ? void 0 : context.parent;
                const isSmallMedia = (parent === null || parent === void 0 ? void 0 : parent.mediaOrientation) === 'landscape'
                    ? parent.landscapeMediaSize === 'small'
                    : (parent === null || parent === void 0 ? void 0 : parent.portraitMediaSize) === 'small';
        ...
        defineField({
            ...
            type: 'string',
            hidden: ({ parent }) => (parent === null || parent === void 0 ? void 0 : parent.mediaOrientation) !== 'landscape',
            initialValue: 'large',
            options: {
                layout: 'radio',
                list: [
        ...
        defineField({
            ...
            type: 'string',
            hidden: ({ parent }) => (parent === null || parent === void 0 ? void 0 : parent.mediaOrientation) !== 'portrait',
        ...
        defineField({
            ...
            title: 'Image',
            type: 'image',
            hidden: ({ parent }) => (parent === null || parent === void 0 ? void 0 : parent.mediaType) !== 'photo',
            options: {
                hotspot: true,
            },
            fields: [
            ...
            validation: (Rule) => Rule.custom((value, context) => {
                const parent = context === null || context === void 0 ? void 0 : context.parent;
                if ((parent === null || parent === void 0 ? void 0 : parent.mediaType) === 'photo' && !value) {
        ...
        defineField({
            ...
            title: 'Video',
            type: 'videoItem',
            hidden: ({ parent }) => (parent === null || parent === void 0 ? void 0 : parent.mediaType) !== 'video',
            validation: (Rule) => Rule.custom((value, context) => {
                const parent = context === null || context === void 0 ? void 0 : context.parent;
                if ((parent === null || parent === void 0 ? void 0 : parent.mediaType) === 'video' && !value) {
    ...
    preview: {
        ...
        prepare({ title, mediaType, mediaOrientation, landscapeMediaSize, portraitMediaSize, }) {
            ...
            if (mediaOrientation === 'portrait') {
                sizeLabel = `, ${portraitMediaSize === 'small'
                    ? 'small'
