...
export const mediaRowSection = defineType({
    ...
    description: 'Render one media type at a time (photos or videos) with a single orientation. Rows show up to four cards before wrapping and stay responsive at smaller breakpoints.',
    type: 'object',
    fields: [
        defineField({
